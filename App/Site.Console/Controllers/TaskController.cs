...
namespace Site.Console.Controllers
{
    ...
    {
        IJobGroupAppService jobGroupService = null;
        IServerNodeAppService serverNodeService = null;
        IJobAppService jobService = null;
        IJobServerHostAppService jobServerHostService = null;
        ITriggerAppService triggerService = null;
        ITriggerServerAppService triggerServerService = null;
        IExecuteLogAppService executeLogService = null;
        IErrorLogAppService errorLogService = null;
        IJobFileAppService jobFileService = null;
        public TaskController()
        {
            jobGroupService = this.Instance<IJobGroupAppService>();
            serverNodeService = this.Instance<IServerNodeAppService>();
            jobService = this.Instance<IJobAppService>();
            jobServerHostService = this.Instance<IJobServerHostAppService>();
            triggerService = this.Instance<ITriggerAppService>();
            triggerServerService = this.Instance<ITriggerServerAppService>();
            executeLogService = this.Instance<IExecuteLogAppService>();
            errorLogService = this.Instance<IErrorLogAppService>();
            jobFileService = this.Instance<IJobFileAppService>();
        }
