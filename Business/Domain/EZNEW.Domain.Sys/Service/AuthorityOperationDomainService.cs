...
namespace EZNEW.Domain.Sys.Service
{
    ...
    /// 授权操作服务
    /// </summary>
    public static class AuthorityOperationDomainService
    {
        static IAuthorityOperationRepository authorityOperationRepository = ContainerManager.Resolve<IAuthorityOperationRepository>();
        ...
        public static Result ModifyStatus(params ModifyAuthorityOperationStatus[] statusInfos)
        {
        ...
        public static Result DeleteAuthorityOperation(IEnumerable<long> authorityOperationIds)
        {
        ...
        public static Result<AuthorityOperation> SaveAuthorityOperation(AuthorityOperation authorityOperation)
        {
        ...
        /// <returns></returns>
        public static AuthorityOperation GetAuthorityOperation(IQuery query)
        {
        ...
        /// <returns></returns>
        public static AuthorityOperation GetAuthorityOperation(long operationId)
        {
            if (operationId <= 0)
            {
                return null;
        ...
        /// <returns></returns>
        public static AuthorityOperation GetAuthorityOperation(string controllerCode, string actionCode)
        {
        ...
        /// <param name="query">查询对象</param>
        /// <returns></returns>
        public static List<AuthorityOperation> GetAuthorityOperationList(IQuery query)
        {
        ...
        /// <returns></returns>
        public static List<AuthorityOperation> GetAuthorityOperationList(IEnumerable<long> ids)
        {
        ...
        /// <param name="query">查询对象</param>
        /// <returns></returns>
        public static IPaging<AuthorityOperation> GetAuthorityOperationPaging(IQuery query)
        {
        ...
        /// <returns></returns>
        public static bool ExistOperationName(string name, long excludeId)
        {
        ...
        /// <returns></returns>
        static List<AuthorityOperation> LoadOtherObjectData(IEnumerable<AuthorityOperation> operations, IQuery query)
        {
            ...
            if (query.AllowLoad<AuthorityOperation>(c => c.Group))
            {
                ...
                groupList = AuthorityOperationGroupDomainService.GetAuthorityOperationGroupList(groupIds);
            }
