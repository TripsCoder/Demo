...
namespace EZNEW.Domain.Sys.Service.Impl
{
    ...
    public class AuthorityService : IAuthorityService
    {
        ...
        public void DeleteAuthority(IEnumerable<string> authorityCodes)
        {
        ...
        /// <returns></returns>
        public bool ExistAuthorityCode(string code)
        {
        ...
        /// <returns></returns>
        public bool ExistAuthorityName(string name, string excludeCode)
        {
