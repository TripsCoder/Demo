...
namespace EZNEW.Repository.CTask
{
    ...
    public class TriggerWeeklyConditionRepository : DefaultAggregationRepository<TriggerCondition, TriggerWeeklyConditionEntity, ITriggerWeeklyConditionDataAccess>, ITriggerWeeklyConditionRepository
    {
        ...
        protected override async Task<IActivationRecord> ExecuteSaveAsync(TriggerCondition data)
        {
            ...
            await RemoveAsync(removeQuery);
            //添加新的条件
            return await SaveEntityAsync(weekEntityList.ToArray()).ConfigureAwait(false);
        }
        ...
        protected override async Task<IActivationRecord> ExecuteRemoveAsync(TriggerCondition data)
        {
            var weeklyCondition = data as TriggerWeeklyCondition;
            if (weeklyCondition == null || weeklyCondition.Days.IsNullOrEmpty())
            {
            ...
            return await RemoveEntityAsync(weekEntityList.ToArray()).ConfigureAwait(false);
        }
