...
namespace EZNEW.Repository.CTask
{
    ...
    public class TriggerConditionRepository : DefaultAggregationRootRepository<TriggerCondition>, ITriggerConditionRepository
    {
        ...
        protected override async Task<IActivationRecord> ExecuteRemoveAsync(TriggerCondition data)
        {
            ...
            await repository.RemoveAsync(data).ConfigureAwait(false);
            return EmptyActivationRecord.Default;
        }
        ...
        protected override async Task<IActivationRecord> ExecuteRemoveAsync(IQuery query)
        {
            ...
            await repository.RemoveAsync(query).ConfigureAwait(false);
            return EmptyActivationRecord.Default;
        }
        ...
        public void RemoveTriggerConditionByTrigger(IEnumerable<Trigger> triggers)
        {
            ...
            {
                repository.RemoveTriggerConditionByTrigger(triggers);
            }
        }
