...
namespace EZNEW.Repository.CTask
{
    ...
    public class TriggerFullDateConditionRepository : DefaultAggregationRepository<TriggerCondition, TriggerFullDateConditionEntity, ITriggerFullDateConditionDataAccess>, ITriggerFullDateConditionRepository
    {
        ...
        protected override async Task<IActivationRecord> ExecuteSaveAsync(TriggerCondition data)
        {
            ...
            Remove(removeQuery);
            //添加新的条件
            return await SaveEntityAsync(fullDateEntityList.ToArray()).ConfigureAwait(false);
        }
        ...
        protected override async Task<IActivationRecord> ExecuteRemoveAsync(TriggerCondition data)
        {
            ...
            return await RemoveEntityAsync(fullDateConditionList.ToArray()).ConfigureAwait(false);
        }
