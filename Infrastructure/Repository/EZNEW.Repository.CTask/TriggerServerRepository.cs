...
namespace EZNEW.Repository.CTask
{
    ...
    public class TriggerServerRepository : DefaultAggregationRepository<TriggerServer, TriggerServerEntity, ITriggerServerDataAccess>, ITriggerServerRepository
    {
        ...
        public void RemoveTriggerServerByTrigger(IEnumerable<Trigger> triggers)
        {
        ...
        public void RemoveTriggerServerByServer(IEnumerable<ServerNode> servers)
        {
        ...
        public void RemoveTriggerServerByJobHost(IEnumerable<JobServerHost> jobServerHosts)
        {
            ...
            RemoveEntity(triggerServerEntityList.ToArray());
        }
