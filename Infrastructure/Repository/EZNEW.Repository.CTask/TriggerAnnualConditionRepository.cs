...
namespace EZNEW.Repository.CTask
{
    ...
    public class TriggerAnnualConditionRepository : DefaultAggregationRepository<TriggerCondition, TriggerAnnualConditionEntity, ITriggerAnnualConditionDataAccess>, ITriggerAnnualConditionRepository
    {
        ...
        protected override async Task<IActivationRecord> ExecuteSaveAsync(TriggerCondition data)
        {
            ...
            Remove(removeQuery);
            //添加信息的计划
            return await SaveEntityAsync(annualDaysEntityList.ToArray()).ConfigureAwait(false);
        }
        ...
        protected override async Task<IActivationRecord> ExecuteRemoveAsync(TriggerCondition data)
        {
            ...
            return await RemoveEntityAsync(annualDaysEntityList.ToArray()).ConfigureAwait(false);
        }
